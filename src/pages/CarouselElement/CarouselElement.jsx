...
export const CarouselElement = (props) => {
    ...
    if (id === 1) {
        return (<div className='main__element'>
                    ...
                    <div className='bulle'>
                        ...
                        <div className='textcontainer'>
                            ...
                            Wir stehen unseren Partnern beratend zur Seite und übernehmen auch die komplette Kommunikation.
                        </div>
                    </div>
                    <div className='bulle'>
                        <div className='imgcontainer'>
                        ...
                        <div className='textcontainer'>
                            ...
                            Von online Werbung bis hin zu Streuartikel haben wir deine Marke im Griff
                        </div>
                    </div>
                    <div className='bulle'>
                        <div className='imgcontainer'>
        ...
        return (<div className='main__element'>
                    <div className='title'>Zusätzlich bieten wir Live-Events und Eventmanagement an</div>
                    <div className='bulle'>
                        <div className='imgcontainer'>
