    ...
    return (
        <>
            ...
            <div className='main__containerNext'>
                ...
                />
                <div className='desc'>
                    <div style={{color: 'rgba(255,255,255,1)', marginBottom: 10}}>Spielbetrieb ist ein ganzheitliches, sexpositives Erlebnis:</div>
                    <span style={{fontWeight: 500}}>Eine Digital-Agentur spezialisiert auf Kommunikation, PR, Eventmanagement sowie Daten- & Jugendschutz.</span>
                </div>
